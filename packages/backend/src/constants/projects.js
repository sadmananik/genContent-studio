...
const PROJECT_MESSAGES = {
  ...
  INVITE_PENDING_CREATED: "Invite saved. The user can create an account to access this project.",
  ...
  PROJECT_EDIT_FORBIDDEN: "Editor access is required to change this project",
  PROJECT_DELETE_OWNER_ONLY: "Project not found or only owners can delete projects",
  PROJECT_UPDATE_OWNER_ONLY: "Project not found or only owners can update projects",
